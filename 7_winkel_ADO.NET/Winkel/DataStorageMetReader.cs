    ...
    public class DataStorageMetReader : DataStorage
    {
        public List<Customer> GetCustomers()
        {
            ...
            using (DbConnection connection = GetConnection())
            {
                ...
                command.CommandText = ConfigurationManager.AppSettings["getAllCustomers"];
                connection.Open();
                try
                {
            ...
            return customers; // Return the populated list
        }
        ...
        public void AddCustomer(Customer customer)
        {
            using (DbConnection connection = GetConnection())
            {
                ...
                command.CommandText = ConfigurationManager.AppSettings["insertCustomer"];
